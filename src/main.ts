...
const deleteTool = new DeleteTool(viewport, selectionManager, interactionLock);
...
setupGUI(viewport, selectionManager, moveTool, deleteTool, extrudeTool, scaleTool, loopCutTool, bevelTool, interactionLock);
